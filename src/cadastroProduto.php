...
if (!empty($_POST['id'])) {
  ...
  $stmtSelect = $conn->prepare('
    INSERT INTO produtos (IDProduto, NomeProduto, IDFornecedor, IDCategoria, QuantidadePorUnidade, PrecoUnitario, UnidadesEmEstoque, UnidadesEmOrdem, NivelDeReposicao, 
    Descontinuado) 
         VALUES (:id, :n, :f, :c, :q, :p, :ue, :uo, :ni, :d);
  ');
  ...
  $stmtSelect->bindValue(':ni', $nivelreposicao);
...
<html lang="pt-br">
  <head>
    ...
    <title>Cadastros de Produtos - Bootstrap</title>
...
<form method="POST">
    ...
    <div class="form-group">
     <label for="produto">Produto : </label>
      <input type="text" class="form-control" name="id" placeholder="id produto">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" name="unidadeEmEstoque" placeholder="quantidade">
    </div>

    <div class="form-group">
      <label for="unidadeEmOrdem">Unidade em Ordem: </label>
      <input type="text" class="form-control" name="unidadeEmOrdem" placeholder="unidadeEmOrdem">
    </div>
